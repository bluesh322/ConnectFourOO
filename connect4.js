...
/** makeHtmlBoard: make HTML table and row of column tops. */
  ...
  placeInTable(y, x) {
    ...
    piece.style.backgroundColor = this.currPlayer.getPlayerColor();
  ...
  handleClick(evt) {
    ...
    // check for win
    if (this.checkForWin()) {
      return this.endGame(`The ${this.currPlayer.getPlayerColor()} player won!`);
    }
...
form.addEventListener('submit', (e) => {
  ...
  const p1 = new Player(player1Color.value);
  const p2 = new Player(player2Color.value);
